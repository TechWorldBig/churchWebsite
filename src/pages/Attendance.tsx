...
export default function Attendance() {
  ...
  return <><PageHero eyebrow="Participation" title="Attendance" description="View member profiles and their attendance information in one place." icon={<CalendarCheck size={15} />} /><section className="attendance-page py-10 sm:py-20"><div className="mx-auto max-w-7xl px-4 sm:px-5 lg:px-8">
